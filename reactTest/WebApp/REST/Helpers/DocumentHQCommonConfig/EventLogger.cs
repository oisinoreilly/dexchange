...
{   
    ...
    public static class EventLogger
    {
        ...
        {
            LogMessage(message, EventLogEntryType.Warning, source);
        }
        ...
        public static void LogException(Exception ex, string source = "")
        {
            ...
            LogMessage(ex.ToString(), EventLogEntryType.Error, source);
        }


        public static void LogMessage(string message, EventLogEntryType entryType, string source = "")
        {
