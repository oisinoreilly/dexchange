...
export class PermissionPicker extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            checked: [],
        ...
        return <div className='permission-picker --align-in-column'>
            ...
            <div className='container'>
                <Panel header={<h2>Select resources to add to role</h2>}>
                    <CheckboxTree nodes={nodes} checked={checked} expanded={expanded} onCheck={this.onCheck} onExpand={this.onExpand} noCascade optimisticToggle={false}/>
                </Panel>
...
//# sourceMappingURL=PermissionPicker.jsx.map