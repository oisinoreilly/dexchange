...
class CorporateConfig extends React.Component {
    constructor() {
        super(...arguments);
        this.state = {
            fields: [],
    ...
    render() {
        ...
        const textFields = this.state.fields.map(field => {
            ...
            return <FormGroup controlId={Name + 'Input'}>
                ...
                <FormControl name={Name} type="text" value={DefaultValue} onChange={this.handleInputChange} componentClass={DefaultValue.length > 20 ? 'textarea' : undefined}/>
        ...
        return <div className="corporate-config-container">
            ...
            <div>
                <FormGroup controlId='LEIInput'>
                    ...
                    <FormControl name='lei' type="text" value={this.state.lei} onChange={this.handleLeiChange}/>
                    <FormControl.Feedback />
                </FormGroup>
...
//# sourceMappingURL=CorporateConfig.jsx.map