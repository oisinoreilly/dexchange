...
import { Status, NotificationType } from '../backendTypes';
import { ReduxProps, withRedux } from './withReduxStore';
...
export class MainPanel extends React.Component<ReduxProps, State> {
    state = {
    ...
    public render() {
        const notificationsModal = <Notifications
            showModal={this.state.showNotificationsModal}
            hideModal={this.handleHideNotificationsModal}
            entity="bank"
            updateDocumentStatus={this.props.actions.updateDocumentStatus}
        />
        ...
        const icon = EntityIcon
            ? <img src={EntityIcon}
                alt={this.props.auth.userConfig.EntityDisplayName + ' icon'} />
